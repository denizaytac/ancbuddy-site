---
{
  ...
  "faqs": [
    ...
    },
    {
      ...
      "a": "Use the download page for the current signed and notarized ANCBuddy 2.2.0 DMG."
    }
  ],
  "breadcrumbs": [
    { "name": "Home", "url": "/" },
...
Install the current public release from the [download page](/download.html). The current public release is ANCBuddy 2.2.0.
