---
{
  ...
  "faqs": [
    {
      "q": "What is ANCBuddy?",
      "a": "ANCBuddy is an independent macOS menu-bar app for Bose QC Ultra headphones and earbuds."
    },
    {
      "q": "Is ANCBuddy affiliated with Bose?",
      "a": "No. ANCBuddy is independent and is not affiliated with, endorsed by, or sponsored by Bose Corporation."
    },
    {
...
ANCBuddy puts daily Bose QC Ultra controls in the Mac menu bar: Quiet, Aware, Immersion, battery and connection status, Launch at Login, update checks, and optional AI Auto-EQ.
