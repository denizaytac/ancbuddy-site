...
- Trial/download flow: the website asks for name and email before starting the DMG download.
...
The public ANCBuddy 2.0.2 DMG is signed with Developer ID, notarized by Apple, and distributed through the ANCBuddy GitHub release asset and Lemon Squeezy download flow. The app includes Sparkle update checks so fixes can ship outside the Mac App Store.
